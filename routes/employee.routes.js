...
const {getEmployees, getEmployeesbyId, createEmployee, updateExit, cancelEmployee} = require('../controller/employee.contoller')
...
employeeRouter.put('/employee/:id', cancelEmployee)
